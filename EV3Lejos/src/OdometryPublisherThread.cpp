...
void Ev3OdomPublisher::setXVel(double xVel){ m_xVel = xVel; }
void Ev3OdomPublisher::setYVel(double yVel){ m_yVel = yVel; }
void Ev3OdomPublisher::setThVel(double thVel){ m_thVel = thVel; }
